...
| `ICDPE-VOLEY-FEDERADO` | `ARANCEL MENSUAL - VOLEY/FEDERADO` |
| `ICDPE-VOLEY-ESCUELA` | `ARANCEL MENSUAL - VOLEY/ESCUELA` |
| `ICDPE-VOLEY-TIRA-*` / escuela legacy | remapeados a FEDERADO / ESCUELA |
