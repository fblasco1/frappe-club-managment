...
When se parsea la etiqueta
Then devuelve actividad `Basquet Masculino`, grupo `Tira Azul`, equipo `U9`.
...
Then crea inscripciones activas para Futbol (TABI A) y Basquet Masculino (Tira Azul / U9)
